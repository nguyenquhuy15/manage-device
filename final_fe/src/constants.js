...
export const MESSAGE = {
  LOGIN_WRONG_USERNAME_OR_PASSWORD: "Tên người dùng hoặc mật khẩu sai!",
  LOGIN_BLOCKED_ACCOUNT: "Tài khoản của bạn đã bị chặn!",
  CHANGE_PASSWORD_WRONG_OLD_PASSWORD: "Mật khẩu cũ không đúng!",
};

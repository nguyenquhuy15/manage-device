...
const DepartmentPage = lazy(() =>
  import("./pages/departments/Department")
);
const DetailDepartmentPage = lazy(() => import("./pages/departments/DetailDepartment"));

//device
const DeviceRoute = lazy(() => import("./pages/devices/DeviceRoute"));
const DevicePage = lazy(() => import("./pages/devices/Device"));
const DetailDevicePage = lazy(() =>
  import("./components/devices/viewdetail/DetailDeviceComponent")
);

//maintenance
const MaintenancePage = lazy(() => import("./pages/maintenance/Maintenance"));
const DetailDeviceMaintenancePage = lazy(() =>
  import("./components/maintenance/viewdetail/DetailDeviceComponent")
);

//loans
const LoanPage = lazy(() => import("./pages/loans/Loan"));
const DetailLoanPage = lazy(() =>
  import("./components/loans/viewdetail/DetailDeviceComponent")
);
...
// type
const TypePage = lazy(() => import("./pages/types/Type"));
...
const ResetPasswordNotification = lazy(() => import("./components/auth/ResetPasswordNotification"));

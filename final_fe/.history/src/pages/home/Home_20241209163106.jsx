    ...
    <>
      ...
      <Container fluid className="p-0">
        ...
        <Row className="justify-content-center">
          ...
          <Col md={4} sm={6} className="mb-4">
            <Card
              className="custom-card device-type-card text-center hover-card"
          ...
          <Col md={4} sm={6} className="mb-4">
            <Card
              className="custom-card device-maintenance-card text-center hover-card"
              onClick={() => handleNavigate("/maintenances")}
            >
              <Card.Body className="d-flex align-items-center justify-content-center">
                <i className="bi bi-tools icon me-3"></i>{" "}
                {/* Icon mới cho Bảo trì */}
          ...
          <Col md={4} sm={6} className="mb-4">
            <Card
              className="custom-card loan-card text-center hover-card"
              onClick={() => handleNavigate("/loans")}
            >
              <Card.Body className="d-flex align-items-center justify-content-center">
                <i className="bi bi-arrow-left-right icon me-3"></i>{" "}
                {/* Icon mới cho Mượn trả */}
                <h4 className="card-title mb-0">Yêu cầu thiết bị</h4>{" "}
                {/* Thay đổi tiêu đề */}
              </Card.Body>
            </Card>
          </Col>

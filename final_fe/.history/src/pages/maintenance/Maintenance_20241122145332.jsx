...
import RemoveAllDeviceModal from "../../components/maintenance/delete/RemoveAllDeviceModal";
...
const MaintenancePage = (props) => {
  ...
  const onDeleteMaintenance = useCallback(async () => {
    ...
    const onRemoveAllMaintenances = useCallback(async () => {
      ...
      <Container fluid className="p-0">
        ...
        {maintenances.length == 0 && isSearchEmpty() && isFilterEmpty() ? (
          ...
          <MaintenanceTableComponent
            ...
            onShowRemoveAllModal={onShowRemoveAllMaintenanceModal}
          />
        )}
        ...
        {isShowRemoveAllMaintenancesModal && (
          <RemoveAllDeviceModal
            ...
            maintenances={maintenances.filter((maintenance) =>
              removingAllDeviceIds.has(maintenance.id)
            )}
            onRemoveAll={onRemoveAllMaintenances}
          />
        )}
      </Container>
    </>

...
const LoanPage = () => {
  ...
  const [totalPagesDevice, setTotalPagesDevice] = useState(0);
  ...
  const getListDevices = async () => {
    const data = await DeviceApi.getAllDevicesByNoLoan({
      page: currentPageDevice,
      sortField: currentSortDevice.sortField,
      isAsc: currentSortDevice.isAsc,
      search: currentSearchDevice,
    });
    setDevices(data.content);
    setTotalPagesDevice(data.totalPagesDevice);
  };

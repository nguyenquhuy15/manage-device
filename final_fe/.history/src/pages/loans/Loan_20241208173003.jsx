...
import DeleteDeviceModal from "../../components/loans/return/DeleteDeviceModal";
...
const [isShowReturnLoanModal, showReturnLoanModal, hideReturnLoanModal] =
  ...
  const onShowReturnLoanModal = (loanId) => {
...
const onReturnLoan = async (returnDate) => {
  try {
    await LoanApi.returnLoan(returningLoanId, returnDate);

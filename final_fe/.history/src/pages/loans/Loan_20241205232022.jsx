...
const LoanPage = () => {
  ...
  const [currentSearchDevices, setCurrentSearchDevices] = useState("");
  const [currentSortDevices, setCurrentSortDevices] = useState({
    sortField: "id",
    isAsc: false,
  });
  const [addingDeviceIds, setAddingEmployeeIds] = useState(new Set());

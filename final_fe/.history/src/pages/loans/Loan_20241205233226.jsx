...
const LoanPage = () => {
  ...
  const onShowCreateDepartmentModal = () => {
    ...
    const onCreateLoai = useCallback(
      async (name, contact, info, loanDate, purpose, deviceIds) => {
        // call api
        await LoanApi.createname, contact, info, loanDate, purpose, Array.from(addingEmployeeIds));
        // show notification

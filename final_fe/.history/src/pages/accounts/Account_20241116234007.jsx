...
const AccountPage = () => {
  ...
  const onCreateA = useCallback(
    async (firstname, lastname, username, email, password) => {
      // call api
      await DeviceApi.create(firstname, lastname, username, email, password);
      // show notification
  ...
  const onShowDeleteAccountModal = useCallback((deviceId) => {
    showDeleteAccountModal();
    setDeletingAccountId(deviceId);
  }, []);

...
const Settings = () => {
  ...
  return (
    ...
    >
      <div className="settings-toggle d-flex align-items-center justify-content-center">
        <div
          className="settings-toggle-option settings-toggle-option-text js-settings-toggle d-flex align-items-center"
          title="Theme Builder"
          onClick={() => setIsOpen(true)}
        >
          <Sliders className="feather align-middle me-2" />{" "}

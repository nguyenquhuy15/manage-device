  ...
  return (
    ...
    >
      {({
        ...
        const isDepartmentSelected = !!values.departmentsId;
        const isSubjectSelected = !!values.subjectsId;
              ...
              <Form id="create-department-form" onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    disabled={isSubjectSelected} // Disable if subject is selected
                  >
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    disabled={isDepartmentSelected} // Disable if department is selected
                  >
                    <option disabled value="">
                      Chọn bộ môn
                    </option>

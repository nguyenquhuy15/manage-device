...
const CreateDepartmentModal = React.memo((props) => {
  ...
  const validationForm = Yup.object({
    ...
    managerName: Yup.string()
      ...
      .max(100, "Must be less than 100 characters")
      .test(
        "checkExistsManagerName",
        "Tên người quản lý đã tồn tại.",
        async (managerName) => {
          const isExists = await props.existsByManagerName(managerName);
          return !isExists;
        }
      ),
    email: Yup.string()
      ...
      .test("checkExistsEmail", "Email này đã tồn tại .", async (email) => {
  ...
  return (
    ...
    >
      {({
        ...
        // Xác định xem trường nào nên bị disable
        const isDepartmentDisabled = Boolean(values.subjectsId);
        const isSubjectDisabled = Boolean(values.departmentsId);

        return (
          <Modal show={true} onHide={props.hideModal}>
            <Modal.Header closeButton>Tạo phòng thí nghiệm/ Phòng thực hành</Modal.Header>
              ...
              <Form id="create-department-form" onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    disabled={isDepartmentDisabled} // Disable nếu subjectsId đã được chọn
                  >
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    disabled={isSubjectDisabled} // Disable nếu departmentsId đã được chọn
                  >
                    <option disabled value="">
                      Chọn bộ môn
                    </option>

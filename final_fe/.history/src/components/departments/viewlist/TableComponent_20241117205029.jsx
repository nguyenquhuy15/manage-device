...
import "./TableComponent.css"; // Import file CSS riêng nếu cần
      ...
      <thead>
        <tr>
          {[
            ...
            { label: "Người quản lí", apiField: "managers.name", width: "20%" },
            { label: "Email", apiField: "managers.email", width: "15%" },
            {
              label: "Số lượng thiết bị",
              apiField: "managers.quantity",
              width: "10%",
            },
      ...
      <tbody>
        {props.departments.map((department) => (
          <tr key={department.id}>
            ...
            <td>{department.managersEmail}</td>
            <td>{department.managersQuantity}</td>

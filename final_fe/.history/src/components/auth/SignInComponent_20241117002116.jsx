...
import logo from "../../assets/img/avatars/logo_banner.png";
  ...
  return (
    <>
                      ...
                      errors.login == MESSAGE.LOGIN_BLOCKED_ACCOUNT && (
                        ...
                        >
                          ...
                          <Modal.Body className="text-center m-3">
                            <p className="mb-0">
                              Tài khoản của bạn không hoạt động, vui lòng kiểm
                              tra email để kích hoạt tài khoản hoặc gửi lại
      ...
      <div className="text-center mb-3">
        Bạn không có tài khoản? <Link to="/auth/sign-up">Đăng kí</Link>
      </div>
    </>
  );
});

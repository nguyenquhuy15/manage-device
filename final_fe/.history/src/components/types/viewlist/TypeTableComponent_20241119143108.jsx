...
import TypeNoDataComponent from "./TypeNoDataComponent";
import AdminContent from "../../../hoc/AdminContent";

const TypeTableComponent = (props) => {
  ...
  //     />
  //   ),
  //   [props.currentFilter, props.maintenances]
  // );
        ...
        <Card.Body>
          <Row className="mb-3">
            ...
            <Col md={8} className="d-flex flex-row-reverse align-items-center">
              ...
              <OverlayTrigger
                placement="bottom"
                overlay={<Tooltip>Create Type</Tooltip>}
              >
              ...
              <OverlayTrigger
                placement="bottom"
                overlay={<Tooltip>Upload Type</Tooltip>}
              >
              ...
              <AdminContent>
                <OverlayTrigger
                  placement="bottom"
                  overlay={<Tooltip>Remove All Type</Tooltip>}
                >

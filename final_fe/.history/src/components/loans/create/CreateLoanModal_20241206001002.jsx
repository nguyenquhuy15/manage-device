...
import DeviceNoDataComponent from "./EmployeeNoDataComponent";
import DeviceTableComponent from "./EmployeeTableComponent";
          ...
          <Modal show={true} onHide={props.hideModal}>
            ...
            <Modal.Body className="m-3">
              <Form id="create-department-form" onSubmit={handleSubmit}>
                ...
                {/* Ngày mượn */}
                <Form.Group className="mb-3">
                  <Form.Label className="required">Ngày mượn</Form.Label>
                  <Form.Control
                    size="md"
                    type="text"
                    name="loanDate"
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    isInvalid={Boolean(touched.purpose && errors.purpose)}
                    onBlur={handleBlur}
                    onChange={handleChange}
                  />
                  {!!touched.purpose && (
              ...
              ) : getDevices(values.managerId).length == 0 &&
                props.isSearchEmpty() ? (

...
const FilterComponent = (props) => {
  ...
  const initForm = {
    loansloansLoanDate:
      props.currentFilter.loansloansLoanDate !== undefined
        ? props.currentFilter.loansloansLoanDate
        : "",
    loansReturnDate:
  ...
  const validationForm = Yup.object({
    loansLoanDate: Yup.date()
      .min(new Date(1970, 10, 10), "Must be greater than 1970")
      .test(
        "loansloansLoanDateGreaterThanReturnDate",
        "Must be less than return date",
        (loansloansLoanDate, obj) => {

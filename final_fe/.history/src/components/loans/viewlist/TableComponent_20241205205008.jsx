        ...
        <tbody>
          {props.loans.map((device) => (
            <tr key={device.id}>
              ...
              <td>{device.loansContact}</td>
              <td>{device.loansInfo}</td>
              <td>{device.loansLoanDate}</td>
              <td>{device.loansQuantity}</td>
              <td>{device.loansReturnDate}</td>
              <td>{device.loansPurpose}</td>

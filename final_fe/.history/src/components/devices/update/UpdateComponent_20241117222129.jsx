...
const UpdateComponent = React.memo((props) => {
  ...
  const validationForm = Yup.object({
    laboratoriesManagerName: Yup.number().required("Required"),
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        size="md"
                        as="select"
                        name="laboratoriesManagerName"
                        value={values.laboratoriesManagerName}
                        isInvalid={Boolean(
                          touched.laboratoriesManagerName &&
                            errors.laboratoriesManagerName
                        )}
                        onBlur={handleBlur}
                        onChange={handleChange}
                      >

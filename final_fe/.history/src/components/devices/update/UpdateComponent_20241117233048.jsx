  ...
  return (
    <Container className="my-4">
      <Card className="shadow-sm border-light">
        <Card.Body>
          <h4 className="text-center mb-4">Cập nhật thông tin thiết bị</h4>
          <Formik
            ...
            {({
              ...
              <Form id="update-device-form" onSubmit={handleSubmit}>
                ...
                <Row className="mb-3">
                  ...
                  <Col md={6}>
                    <Row>
                      <Col md={6}>
                        <Form.Group>
                          <Form.Label className="required">Ngày bàn giao thiết bị</Form.Label>
                          <Form.Control
                            size="md"
                            type="date"
                            name="detailsAssignmentDate"
                            value={values.detailsAssignmentDate}
                            isInvalid={Boolean(touched.detailsAssignmentDate && errors.detailsAssignmentDate)}
                            onBlur={handleBlur}
                      ...
                      <Col md={6}>
                        <Form.Group>
                          ...
                          <Form.Select
                            ...
                            isInvalid={Boolean(touched.laboratoriesId && errors.laboratoriesId)}
                            onBlur={handleBlur}
                            onChange={handleChange}
                          >
                ...
                <Row className="mb-3">
                  <Col md={12}>
                    <Form.Group>
                      ...
                      <Form.Control
                        as="textarea"
                        rows={5} // Chiều cao của textarea
                        name="detailsNote"
                        value={values.detailsNote}
                        isInvalid={Boolean(touched.detailsNote && errors.detailsNote)}
                        onBlur={handleBlur}
                        onChange={handleChange}
                      />
                      <Form.Control.Feedback type="invalid">
                  ...
                  <Col md={6}>
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        isInvalid={Boolean(touched.maintenanceDate && errors.maintenanceDate)}
                        onBlur={handleBlur}
                        onChange={handleChange}
                      />
                      <Form.Control.Feedback type="invalid">
                ...
                <Row className="mb-3">
                  <Col md={12}>
                    <Form.Group>
                      <Form.Label className="required">Thông tin bảo trì</Form.Label>
                      <Form.Control
                        size="md"
                        type="text"
                        name="maintenanceDescription"
                        value={values.maintenanceDescription}
                        isInvalid={Boolean(touched.maintenanceDescription && errors.maintenanceDescription)}
                        onBlur={handleBlur}
                        onChange={handleChange}
                      />
                      <Form.Control.Feedback type="invalid">

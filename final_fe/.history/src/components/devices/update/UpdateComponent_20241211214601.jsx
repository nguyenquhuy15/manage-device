...
import "./update.css"; // Import file CSS
...
const UpdateComponent = React.memo((props) => {
  ...
  useEffect(() => {
    document.body.style.backgroundColor = "#d0e6f7"; // Màu nền toàn trang đậm hơn
    return () => {
  ...
  return (
    <Container
      className="my-4"
      style={{
        backgroundColor: "#d0e6f7", // Màu nền xanh đậm hơn
        padding: "20px",
        borderRadius: "8px",
      }}
    >
      <Card
        ...
        style={{
          backgroundColor: "#ffffff", // Màu nền trắng cho thẻ
          border: "1px solid #ccc",
          boxShadow: "0 4px 6px rgba(0, 0, 0, 0.2)", // Đổ bóng đậm hơn
        }}
      >
        <Card.Body>
          <Formik

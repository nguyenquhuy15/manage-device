...
const FilterComponent = (props) => {
  ...
  const handleSubmitForm = (values) => {
    if (
      props.currentFilter.name != values.minDate ||
      props.currentFilter.typeName != values.maDatex ||
      props.currentFilter.status != values.minMember ||
      props.currentFilter.laboratoriesName != values.maxMember
    ) {

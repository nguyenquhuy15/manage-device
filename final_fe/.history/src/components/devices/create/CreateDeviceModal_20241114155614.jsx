...
const CreateDeviceModal = React.memo((props) => {
    ...
    >
      {({
        ...
        <Modal show={true} onHide={props.hideModal}>
          <Modal.Header closeButton>Create Device Modal</Modal.Header>
            ...
            <Form id="create-device-form" onSubmit={handleSubmit}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  type="date"
                  name="warrantyDate"
                  placeholder="Nhập ngày bảo trì(Chưa bảo trì không cần nhập)"
              ...
              <Form.Group className="mb-2">
                ...
                >
                  ...
                  <option value="Rảnh">AVAILABLE</option>
                  <option value="Đang sử dụng">INUSE</option>

...
const featuresSection = [
  ...
  {
    href: "/departments",
    icon: Sliders, // Remains the same
    title: "Khoa/Viện",
    roles: [ROLE.ADMIN, ROLE.MANAGER],
  },
  {
    href: "/maintenances",
    icon: Settings, // Changed to Users to indicate groups of users
    title: "Bảo trì",
    roles: [ROLE.ADMIN, ROLE.MANAGER],
  },
  {
    href: "/groups",
    icon: Users, // Changed to Users to indicate groups of users
    title: "Groups",
    roles: [ROLE.ADMIN, ROLE.MANAGER],
  },
];

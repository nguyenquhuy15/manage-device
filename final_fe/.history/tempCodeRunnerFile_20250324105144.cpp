...
// of threads. The program should print the index of the target string and the number of
// threads that stopped early.  
//
// 4. Implement a parallel program to search for a target string in a large array of strings.
// Each thread searches a chunk of the array. If one thread finds the string, it reports the
// index and stops all other threads. Use a shared flag to synchronize early stopping
// of threads. The program should print the index of the target string and the number of
// threads that stopped early.
//
// 5. Implement a parallel program to search for a target string in a large array of strings.
// Each thread searches a chunk of the array. If one thread finds the string, it reports the
// index and stops all other threads. Use a shared flag to synchronize early stopping
// of threads. The program should print the index of the target string and the number of
// threads that stopped early.
//
// 6. Implement a parallel program to search for a target string in a large array of strings.
// Each thread searches a chunk of the array. If one thread finds the string, it reports the

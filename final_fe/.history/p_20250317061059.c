//lab1
//1
// # Di chuyển đến thư mục user của bạn
// cd ~

// # Tạo hai thư mục con Slides, Labs và một tệp Solution.txt
// mkdir Slides Labs
// touch Solution.txt
...
// # Tạo thư mục con Lab1 và tệp Ex1.txt
// mkdir Lab1
// touch Ex1.txt

// # Sao chép tệp Ex1.txt từ thư mục Labs vào thư mục Lab1
// cp Ex1.txt Lab1/

// # Xóa tệp Ex1.txt bên trong thư mục Labs
// rm Ex1.txt

// # Đổi tên tệp Ex1.txt thành Exercise1.txt bên trong Lab1
// mv Lab1/Ex1.txt Lab1/Exercise1.txt

// # Thêm quyền ghi vào tệp Exercise1.txt cho những người dùng khác
// chmod o+w Lab1/Exercise1.txt
...
// # 3. ls -al
// ls -al  # Liệt kê tất cả các tệp và thư mục (bao gồm ẩn) với thông tin chi tiết

// # 4. cd .
// cd .  # Di chuyển đến chính thư mục hiện tại

// # 5. pwd
// pwd  # Đường dẫn không thay đổi vì cd . không thay đổi thư mục

// # 6. cd ..
// cd ..  # Di chuyển lên thư mục cha

// # 7. pwd
// pwd  # Hiển thị đường dẫn thư mục cha

// # 8. ls -al
// ls -al  # Liệt kê tất cả các tệp và thư mục trong thư mục cha

// # 9. cd ..
// cd ..  # Tiếp tục di chuyển lên thư mục cha

// # 10. pwd
// pwd  # Hiển thị đường dẫn thư mục hiện tại (ở mức cao hơn)

// # 11. ls -al
// ls -al  # Liệt kê tất cả các tệp và thư mục trong thư mục hiện tại

//3 
// # Di chuyển đến thư mục Lab1
// cd ~/Labs/Lab1

// # Tạo tệp Hello.txt và ghi nội dung vào tệp
// echo "Hello everyone!
...
// Are you ready?" > Hello.txt


//4 
// # 1. Tạo tệp Ex4_results.txt chứa tên và thuộc tính của các thư mục và tệp
// ls -al ~ > Ex4_results.txt

// # 2. Đếm số tệp và thư mục và lưu vào cuối tệp
// ls ~ | wc -l >> Ex4_results.txt

// # 3. In dòng thứ 3 của tệp Hello.txt, đếm số từ và lưu vào cuối tệp
// sed -n '3p' Hello.txt > temp.txt
// wc -w temp.txt >> Ex4_results.txt
// rm temp.txt

// # 4. Đếm số từ "course" trong Hello.txt và lưu vào cuối tệp
// grep -o "course" Hello.txt | wc -l >> Ex4_results.txt

// # 5. Đếm tổng số quy trình hiện có trong hệ thống và lưu vào cuối tệp
// ps -e | wc -l >> Ex4_results.txt

//5
// #!/bin/bash
// # Tác giả: [Tên của bạn]
// # Script: greeting.sh
// # Mục đích: Hiển thị thông tin hệ thống và người dùng
...
// echo "PATH: $PATH"
// echo "HOME: $HOME"
// echo "Goodbye, current time is $(date +%T)"

//6
// #!/bin/bash
// # Script in dãy Fibonacci
